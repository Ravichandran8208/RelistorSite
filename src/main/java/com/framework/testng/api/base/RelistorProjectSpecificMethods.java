...
import com.framework.selenium.api.base.RelistorSeleniumBase;
import com.framework.selenium.api.design.Locators;
import com.framework.utils.RelistorDataLibrary;

public class RelistorProjectSpecificMethods extends RelistorSeleniumBase {
...
//	creditNoteBillNo,TransactionID;
	...
	public Object[][] fetchData() throws IOException {
		return RelistorDataLibrary.readExcelData(excelFileName, sheetName);
	}
	...
	public void preCondition() throws IOException {
		try {
			FileInputStream config = new FileInputStream("./src/main/resources/Relistorconfig.properties");
			prop = new Properties();
			prop.load(config);
